...
##### testrecipes ####
    ...
    "wwNLL_13TeV": {
        ...
        "do4MC": True,
        "do4Data": False,
        "import": "mkShapesRDF.processor.modules.wwNLLWeightProducer",
        "declare": 'wwNNLProducer = lambda : wwNLLWeightProducer("RPLME_SAMPLENAME", "13TeV", "RPLME_FW")', 
        "module": "wwNNLProducer()", ## 13TeV is a folder in data/wwresum
    },
    ...
    "ggwwKFactor_13TeV": {
        ...
        "do4MC": True,
        "do4Data": False,
        "import": "mkShapesRDF.processor.modules.ggwwNNLOWeightProducer",
        "declare": 'ggwwKfactor = lambda : ggwwNNLOWeightProducer("Kfactor_Collected_ggHZZ_2l2l_NLO_NNPDF_NarrowWidth_13TeV.root","Kfactor_Collected_ggHZZ_2l2l_NNLO_NNPDF_NarrowWidth_13TeV.root", "RPLME_SAMPLENAME", "RPLME_FW")',
        "module": "ggwwKfactor()",
    },
