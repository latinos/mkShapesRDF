Steps = {
    ...
    "DATAl1loose2022EEv12__addTnPMuon": {
        "isChain": True,
        "do4MC": False,
        "do4Data": True,
        "selection": '"((nElectron+nMuon)>0)"',
    ...
    "DATAl1loose2022EEv12__addTnPElectron": {
        "isChain": True,
        "do4MC": False,
        "do4Data": True,
        "selection": '"((nElectron+nMuon)>0)"',
    ...
    "DATAl1loose2022v12__addTnPMuon": {
        "isChain": True,
        "do4MC": False,
        "do4Data": True,
        "selection": '"((nElectron+nMuon)>0)"',
    ...
    "DATAl1loose2022v12__addTnPElectron": {
        "isChain": True,
        "do4MC": False,
        "do4Data": True,
        "selection": '"((nElectron+nMuon)>0)"',
    ...
    "DATAl1loose2023v12__addTnPMuon": {
        "isChain": True,
        "do4MC": False,
        "do4Data": True,
        "selection": '"((nElectron+nMuon)>0)"',
    ...
    "DATAl1loose2023v12__addTnPElectron": {
        "isChain": True,
        "do4MC": False,
        "do4Data": True,
        "selection": '"((nElectron+nMuon)>0)"',
    ...
    "DATAl1loose2023BPixv12__addTnPMuon": {
        "isChain": True,
        "do4MC": False,
        "do4Data": True,
        "selection": '"((nElectron+nMuon)>0)"',
    ...
    "DATAl1loose2023BPixv12__addTnPElectron": {
        "isChain": True,
        "do4MC": False,
        "do4Data": True,
        "selection": '"((nElectron+nMuon)>0)"',
    ...
    "MCl1loose2022v12__addTnPElectron": {
        "isChain": True,
        "do4MC": True,
        "do4Data": False,
        "selection": '"((nElectron+nMuon)>0)"',
    ...
    "MCl1loose2022EEv12__addTnPMuon": {
        "isChain": True,
        "do4MC": True,
        "do4Data": False,
        "selection": '"((nElectron+nMuon)>0)"',
    ...
    "MCl1loose2022EEv12__addTnPElectron": {
        "isChain": True,
        "do4MC": True,
        "do4Data": False,
        "selection": '"((nElectron+nMuon)>0)"',
    ...
    "MCl1loose2023v12__addTnPElectron": {
        "isChain": True,
        "do4MC": True,
        "do4Data": False,
        "selection": '"((nElectron+nMuon)>0)"',
    ...
    "MCl1loose2023BPixv12__addTnPMuon": {
        "isChain": True,
        "do4MC": True,
        "do4Data": False,
        "selection": '"((nElectron+nMuon)>0)"',
        "subTargets": [
            ...
            "trigMCnoSF_2023BPix",
            "l2Kin",
            "formulasMCnoSF_2023BPix",
            "addTnPMuon",
        ]
    },
    "MCl1loose2023BPixv12__addTnPElectron": {
        "isChain": True,
        "do4MC": True,
        "do4Data": False,
        "selection": '"((nElectron+nMuon)>0)"',
    ...
    "lepSel_Summer23":{
        ...
        "do4Data": True,
        "import": "mkShapesRDF.processor.modules.LeptonSel",
        "declare": 'leptonSel = lambda : LeptonSel("Loose", 1, "Full2023v12")',
        "module": "leptonSel()",
    },
    "lepSel_Summer23BPix":{
        "isChain": False,
        ...
        "do4Data": True,
        "import": "mkShapesRDF.processor.modules.LeptonSel",
        "declare": 'leptonSel = lambda : LeptonSel("Loose", 1, "Full2023BPixv12")',
        "module": "leptonSel()",
    },
    "lepSel_Summer22BCD":{
        "isChain": False,
    ...
    "jetSelMask_2023": {
        ...
        "do4Data": True,
        "import": "mkShapesRDF.processor.modules.JetSelMaskBCD",
        "declare": 'jetSelMask = lambda : JetSelMaskBCD(2,"loose",15.0,4.7,False,"RPLME_FW/processor/data/jetvetomaps/Run2023/jetvetomaps.json","Summer23Prompt23_RunC_V1")',
        "module": "jetSelMask()",
    },
    "jetSelMask_2023BPix": {
        "isChain": False,
        ...
        "do4Data": True,
        "import": "mkShapesRDF.processor.modules.JetSelMaskBCD",
        "declare": 'jetSelMask = lambda : JetSelMaskBCD(2,"loose",15.0,4.7,False,"RPLME_FW/processor/data/jetvetomaps/Run2023BPix/jetvetomaps.json","Summer23BPixPrompt23_RunD_V1")',
        "module": "jetSelMask()",
    },
    "fakeSelMC": {
        "isChain": False,
    ...
    "lumiMask23": {
        ...
        "do4Data": True,
        "import": "mkShapesRDF.processor.modules.LumiMask",
        "declare": "lumiMask = lambda : LumiMask('RPLME_FW/processor/data/certification/Cert_Collisions2023_366442_370790_Golden.json')",
        "module": "lumiMask()",
    },
    "PromptParticlesGenVars": {
        "isChain": False,
    ...
    "formulasMCnoSF_2023": {
        ...
        "do4MC": True,
        "do4Data": False,
        "import": "mkShapesRDF.processor.modules.formulasToAdd_MCnoSF_Full2023v12",
        "declare": "formulasMC = lambda : formulasToAdd_MCnoSF_Full2023v12()",
        "module": "formulasMC()",
    },
    "formulasMCnoSF_2023BPix": {
        "isChain": False,
        "do4MC": True,
        "do4Data": False,
        "import": "mkShapesRDF.processor.modules.formulasToAdd_MCnoSF_Full2023BPixv12",
        "declare": "formulasMC = lambda : formulasToAdd_MCnoSF_Full2023BPixv12()",
        "module": "formulasMC()",
    },
    "formulasFAKE_2022FG": {
        "isChain": False,
    ...
    "trigMCnoSF_2023": {
        ...
        "do4Data": False,
        "import": "mkShapesRDF.processor.modules.TrigMaker",
        "declare": 'trigMC = lambda : TrigMaker("Full2023v12", isData=False, keepRunP=False, computeSF=False)',
        "module": "trigMC()",
    },
    "trigMCnoSF_2023BPix": {
        "isChain": False,
        ...
        "do4Data": False,
        "import": "mkShapesRDF.processor.modules.TrigMaker",
        "declare": 'trigMC = lambda : TrigMaker("Full2023BPixv12", isData=False, keepRunP=False, computeSF=False)',
        "module": "trigMC()",
    },
    "trigData": {
        "isChain": False,
    ...
    "trigData2023": {
        ...
        "do4Data": True,
        "import": "mkShapesRDF.processor.modules.TrigMaker",
        "declare": 'trigData = lambda : TrigMaker("Full2023v12", isData=True, keepRunP=False)',
        "module": "trigData()",
    },
    "trigData2023BPix": {
        "isChain": False,
        ...
        "do4Data": True,
        "import": "mkShapesRDF.processor.modules.TrigMaker",
        "declare": 'trigData = lambda : TrigMaker("Full2023BPixv12", isData=True, keepRunP=False)',
        "module": "trigData()",
    },
    "fakeW_2022FG": {
        "isChain": False,
    ...
    "addTnPMuon": {
        ...
        "declare": "doTnP_muon = lambda : addTnPTree('2022', 'Muon', True, 'RPLME_EOSPATH', 'RPLME_OUTPUTFILENAME')",
        "module": "doTnP_muon()",
    },
    "addTnPElectron": {
        "isChain": False,
        ...
        "do4Data": True,
        "import": "mkShapesRDF.processor.modules.addTnPTree",
        "declare": "doTnP_electron = lambda : addTnPTree('2022', 'Electron', True, 'RPLME_EOSPATH', 'RPLME_OUTPUTFILENAME')",
