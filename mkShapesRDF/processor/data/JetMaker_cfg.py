...
JetMakerCfg = {
    ...
    'Full2024v15': {
        "vetomap": frameworkPath + "/processor/data/jsonpog-integration/POG/JME/2024_Summer24/jetvetomaps.json.gz",
        "vetokey": "Summer24Prompt24_RunBCDEFGHI_V1",
        "JEC": "Summer24Prompt24_V1_MC",
        "JER": "Summer23BPixPrompt23_RunD_JRV1_MC",
        "jet_jerc" : frameworkPath + "/processor/data/jsonpog-integration/POG/JME/2024_Summer24/jet_jerc.json.gz",
        "jer_smear": frameworkPath + "/processor/data/jsonpog-integration/POG/JME/jer_smear.json.gz",
        "jetId": {
