    ...
    "Full2023v12": {
        ...
        "TightObjWP": {
            "wp90iso": {
                ...
                'tkSF':  {
                    '1-1' : ["Electron-ID-SF", "data/scale_factor/Full2023v12/electron_POG.json"]
                } ,
                'wpSF':  {
                    '1-1' : ["Electron-ID-SF", 'data/scale_factor/Full2023v12/electron_POG.json'],
                } ,
            ...
            "mvaWinter22V2Iso_WP90": {
                ...
                'wpSF':  {
                    '1-1' : ["NUM_Electron_mvaWinter22V2IsoWP90_DEN_ElectronTrack", 'data/scale_factor/Full2023v12/electron_scale.json'],
                } ,
            ...
            "mvaWinter22V2Iso_WP90_tthmva_97": {
                ...
                'tkSF':  {
                    '1-1' : ["2022FG-Electron-ID-SF", "data/scale_factor/Full2023v12/electron_POG.json"]
                } ,
                'wpSF':  {
                    '1-1' : ["NUM_Electron_mvaWinter22V2IsoWP90_DEN_ElectronTrack", 'data/scale_factor/Full2023v12/electron_scale.json'],
                } ,
            ...
            "LooseMVA_HWW": {
                ...
                #'wpSF':  {
                #    '1-1' : ["NUM_Electron_LooseMVA-HWW_DEN_ElectronTrack", 'data/scale_factor/Full2023v12/electron_scale.json'], 
                #} , 
                'fakeW' : 'data/fake_prompt_rates/Full2023v12/mvaWinter22V2Iso_WP90/',
            },
            "TightMVA_HWW": {
                ...
                #'wpSF':  {
                #    '1-1' : ["NUM_Electron_TightMVA-HWW_DEN_ElectronTrack", 'data/scale_factor/Full2023v12/electron_scale.json'],
                #} ,
                'fakeW' : 'data/fake_prompt_rates/Full2023v12/mvaWinter22V2Iso_WP90/',
            },
        },
    ...
    "Full2023BPixv12": {
        ...
        "TightObjWP": {
            "wp90iso": {
                ...
                'tkSF':  {
                    '1-1' : ["Electron-ID-SF", "data/scale_factor/Full2023BPixv12/electron_POG.json"]
                } ,
                'wpSF':  {
                    '1-1' : ["Electron-ID-SF", 'data/scale_factor/Full2023BPixv12/electron_POG.json'],
                } ,
            ...
            "mvaWinter22V2Iso_WP90": {
                ...
                'wpSF':  {
                    '1-1' : ["NUM_Electron_mvaWinter22V2IsoWP90_DEN_ElectronTrack", 'data/scale_factor/Full2023BPixv12/electron_scale.json'],
                } ,
            ...
            "mvaWinter22V2Iso_WP90_tthmva_97": {
                ...
                'tkSF':  {
                    '1-1' : ["2022FG-Electron-ID-SF", "data/scale_factor/Full2023BPixv12/electron_POG.json"]
                } ,
                'wpSF':  {
                    '1-1' : ["NUM_Electron_mvaWinter22V2IsoWP90_DEN_ElectronTrack", 'data/scale_factor/Full2023BPixv12/electron_scale.json'],
                } ,
            ...
            "LooseMVA_HWW": {
                ...
                #'wpSF':  {
                #    '1-1' : ["NUM_Electron_LooseMVA-HWW_DEN_ElectronTrack", 'data/scale_factor/Full2022EEv12/electron_scale.json'], 
                #} , 
                'fakeW' : 'data/fake_prompt_rates/Full2023BPixv12/mvaWinter22V2Iso_WP90/',
            },
            "TightMVA_HWW": {
                ...
                #'wpSF':  {
                #    '1-1' : ["NUM_Electron_TightMVA-HWW_DEN_ElectronTrack", 'data/scale_factor/Full2023BPixv12/electron_scale.json'],
                #} ,
                'fakeW' : 'data/fake_prompt_rates/Full2023BPixv12/mvaWinter22V2Iso_WP90/',
            },
        },
    ...
    "Full2023v12": {
        ...
        "TightObjWP": {
            "cut_TightID_POG": {
                ...
                "idSF": {
                    "1-1": ["NUM_TightID_DEN_TrackerMuons", "data/scale_factor/Full2023v12/muon_POG.json"],
                },
                "isoSF": {
                    "1-1": ["NUM_TightPFIso_DEN_TightID", "data/scale_factor/Full2023v12/muon_POG.json"],
                },
                "fakeW": "data/fake_prompt_rates/Full2023v12/cut_TightID_POG/",
            },
            "cut_Tight_HWW": {
                "cuts": {
                    "ROOT::RVecB (Muon_pt.size(), true)": [
            ...
            "cut_TightMiniIso_HWW": {
                ...
                "isoSF": {
                    "1-1": ["NUM_TightIDMiniIso_DEN_TightID", "data/scale_factor/Full2023v12/muon_scale.json"],
                },
                "fakeW": "data/fake_prompt_rates/Full2023v12/cut_TightMiniIso_HWW/",
            },
            "cut_Tight_HWW_tthmva_67": {
                "cuts": {
                    "ROOT::RVecB (Muon_pt.size(), true)": [
            ...
            "cut_LooseMVA_HWW": {
                ...
                #"isoSF": {
                #    "1-1": ["NUM_LooseMVA-HWW_DEN_MediumID", "data/scale_factor/Full2023v12/muon_scale.json"],
                #},
                "fakeW": "data/fake_prompt_rates/Full2022EEv12/cut_Tight_HWW/",
            },
            "cut_TightMVA_HWW": {
                ...
                #"isoSF": {
                #    "1-1": ["NUM_TightMVA-HWW_DEN_MediumID", "data/scale_factor/Full2023v12/muon_scale.json"],
                #},
                "fakeW": "data/fake_prompt_rates/Full2023v12/cut_Tight_HWW/",
            },
        },
    ...
    "Full2023BPixv12": {
        ...
        "TightObjWP": {
            "cut_TightID_POG": {
                ...
                "idSF": {
                    "1-1": ["NUM_TightID_DEN_TrackerMuons", "data/scale_factor/Full2023BPixv12/muon_POG.json"],
                },
                "isoSF": {
                    "1-1": ["NUM_TightPFIso_DEN_TightID", "data/scale_factor/Full2023BPixv12/muon_POG.json"],
                },
                "fakeW": "data/fake_prompt_rates/Full2023BPixv12/cut_TightID_POG/",
            },
            "cut_Tight_HWW": {
                "cuts": {
                    "ROOT::RVecB (Muon_pt.size(), true)": [
            ...
            "cut_TightMiniIso_HWW": {
                ...
                "isoSF": {
                    "1-1": ["NUM_TightIDMiniIso_DEN_TightID", "data/scale_factor/Full2023BPixv12/muon_scale.json"],
                },
                "fakeW": "data/fake_prompt_rates/Full2023BPixv12/cut_TightMiniIso_HWW/",
            },
            "cut_Tight_HWW_tthmva_67": {
                "cuts": {
                    "ROOT::RVecB (Muon_pt.size(), true)": [
            ...
            "cut_LooseMVA_HWW": {
                ...
                #"isoSF": {
                #    "1-1": ["NUM_LooseMVA-HWW_DEN_MediumID", "data/scale_factor/Full2023BPixv12/muon_scale.json"],
                #},
                "fakeW": "data/fake_prompt_rates/Full2023BPixv12/cut_Tight_HWW/",
            },
            "cut_TightMVA_HWW": {
                ...
                #"isoSF": {
                #    "1-1": ["NUM_TightMVA-HWW_DEN_MediumID", "data/scale_factor/Full2023BPixv12/muon_scale.json"],
                #},
                "fakeW": "data/fake_prompt_rates/Full2023BPixv12/cut_Tight_HWW/",
            },
        },
