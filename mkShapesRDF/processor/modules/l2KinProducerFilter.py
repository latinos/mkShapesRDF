...
class l2KinProducerFilter(Module):
    def __init__(self):
    ...
    def runModule(self, df, values):
        ...
        ##### Make analysis pre-filter
        df = df.Filter("Lepton_pt[0]>25 && Lepton_pt[1] > 10. && (abs(Lepton_pdgId[1]) == 13 || Lepton_pt[1] > 13.) && (Alt(Lepton_pt,2, 0) < 10.) && ptll>15 && mll>12")
