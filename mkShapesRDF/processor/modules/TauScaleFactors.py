...
class TauScaleFactors(Module):
    ...
    def runModule(self, df, values):
        ...
        df = df.Redefine("TES_MET_pt", "doTauMET(Tau_pt, Tau_Scale_pt, Tau_phi, MET_pt, MET_phi)[0]")
        df = df.Redefine("TES_MET_phi", "doTauMET(Tau_pt, Tau_Scale_pt, Tau_phi, MET_pt, MET_phi)[1]")
