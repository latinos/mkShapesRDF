...
resubmitLine = "queue 1 Folder in top_0"
condorFolder = 'condor/gitlab_test'
...
for sample in samples:
    ...
    fSh += f'cp /afs/cern.ch/user/s/squinto/private/work/mkShapesRDF_histogramming/mkShapesRDF/shapeAnalysis/runner.py . \n'
